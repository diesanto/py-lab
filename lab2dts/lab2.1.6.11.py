...
if it accepts an invalid time - the most important thing is that the code produce valid results for valid input data.
...
duration = mins + dura 
minutes  = duration % 60
hours    = (hour + (duration // 60)) % 24

print('Event will end at', hours, minutes, sep=' : ')